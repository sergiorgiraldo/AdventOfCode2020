...
3: \"b\""""
        ...
        rule = Rules(list)
        self.assertTrue(rule.match("aab"))
...
aaabbb
aaaabbb"""
        self.assertEqual(solution.get_matches_rule0(list), 2, "Oops")
...
aabbbbbaabbbaaaaaabbbbbababaaaaabbaaabba"""
        ...
        self.assertEqual(solution.get_matches_rule0_after_fix(list), 12, "Oops")
